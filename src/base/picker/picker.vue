    ...
    methods: {
      confirm() {
        ...
        for (let i = 0; i < this.pickerData.length; i++) {
          ...
          this.pickerSelectedValue[i] = this.pickerData[i][index].value
        }
        this.$emit(EVENT_SELECT, this.pickerSelectedVal, this.pickerSelectedIndex, this.pickerSelectedText, this.pickerSelectedValue)
        if (changed) {
          this.$emit(EVENT_VALUE_CHANGE, this.pickerSelectedVal, this.pickerSelectedIndex, this.pickerSelectedText, this.pickerSelectedValue)
        }
      },
      cancel() {
        this.hide()
